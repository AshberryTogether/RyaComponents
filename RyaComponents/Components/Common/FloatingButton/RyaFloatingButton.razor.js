export function createFloatingButton(floatingButton, buttonContainerSelector) {
    var containerNode = document.querySelector(buttonContainerSelector);
    containerNode.appendChild(floatingButton);
}

export function removeFloatingButton(floatingButton) {
